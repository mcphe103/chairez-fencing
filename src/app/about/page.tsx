...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "About Chairez Fencing",
    description:
    "Reliable, affordable, professional fencing and deck projects.",
...
export default function AboutPage() {
        ...
        <div className="max-w-7xl mx-auto px-6 grid gap-8 md:grid-cols-2 md:gap-12">
          <div className="self-center">
            ...
            <p className="text-slate-700 mt-3 leading-relaxed">
              Whether you need backyard privacy, a deck for weekend gatherings, or a secure iron gate—we’re here to help you plan and build with confidence.
            </p>
            <p className="text-slate-700 mt-3 leading-relaxed">
  ...
  {/* Credentials / What We Build */}
    ...
    <div className="rounded-2xl border border-slate-200 p-6 shadow-sm bg-slate-50">
      ...
      {/* Build list */}
      <ul className="space-y-2 text-slate-700 list-disc pl-6">
        <li>Wood Fencing (privacy, custom builds, repairs)</li>
        <li>Ornamental Iron Fencing & Gates (security and decorative installations)</li>
        <li>Deck Construction & Restoration</li>
      </ul>
    </div>
  </div>
</section>

  ...
  const images: GalleryImage[] = [
    {
      ...
      alt: "Ornamental iron fence installation by Chairez Fencing",
    },
    {
      src: "/images/gallery/gates/wood-gate-01.jpeg",
      alt: "Custom wood side gate installation",
    },
    {
      src: "/images/gallery/gates/wood-gate-02.jpeg",
      alt: "Wood privacy gate with latch hardware",
    },
    {
      src: "/images/gallery/gates/wood-gate-03.jpeg",
      alt: "Custom backyard wood gate",
    },
    {
      src: "/images/gallery/gates/wood-gate-04.jpeg",
      alt: "Wood driveway gate built by Chairez Fencing",
    },
  ];
  return (
    <main className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <p className="mt-3 text-slate-700">
          Ornamental iron fencing and gates — including repairs and custom installations.
        </p>
      </div>

...
export default function DecksGalleryPage() {
  ...
  const images: GalleryImage[] = [
    {
      src: "/images/gallery/decks/deck-01.jpg",
      alt: "Custom backyard deck construction with wood railing",
    },
    {
      src: "/images/gallery/decks/deck-02.jpg",
      alt: "Raised wood deck installation by Chairez Fencing",
    },
    {
      src: "/images/gallery/decks/deck-03.jpg",
      alt: "Newly built outdoor deck with staircase access",
    },
  ];
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
        ...
        <h1 className="mt-2 text-4xl font-bold text-slate-900">Decks</h1>

        <p className="mt-3 text-slate-700">
          A growing collection of custom deck projects designed for outdoor living and durability.
        </p>
      </div>
      ...
      {images.length > 0 ? (
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-slate-700">
            We’re currently organizing deck project albums. If you’d like to
            see recent examples, contact us and we’ll be happy to share them.
          </p>
